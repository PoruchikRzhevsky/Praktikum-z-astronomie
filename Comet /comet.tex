...
% \end{lstlisting}
    ...
    \begin{minipage}[t]{0.5\textwidth} 
        ...
        \subsection{Popis paipelinu}    
            ...
            \captionof{figure}{Ekvatoriální souřadnice hvězd a komety}
...
\newpage
    \begin{minipage}[t]{1\textwidth} 
            ...
            \captionsetup{justification=centering, font=footnotesize}
            \captionof{figure}{Snímek noční oblohy s vyznačenými hvězdami, cometou a centrem čipu}
    ...
    \begin{minipage}[t]{0.5\textwidth}
            ...
            \captionsetup{justification=centering, font=footnotesize}
            \captionof{figure}{Obrázek komety s vyznačenou oblastí zájmu}
...
\newpage
    \begin{minipage}[t]{1\textwidth} 
        ...
        \captionsetup{justification=centering, font=footnotesize}
        \captionof{figure}{Obrázek komety s kalibračními hvězdami a oblastí pozadí}
        \label{fig:comet}
        \vspace{10pt}
        \raggedright 
    \end{minipage}
...
\newpage
    \begin{minipage}[t]{0.5\textwidth}
        ...
        \captionof{figure}{Radiální profil jasu povrchu komety (mag)}
        \label{fig:sbp}
        \vspace{10pt}
        \raggedright 
        ...
        \captionsetup{justification=centeringfont=footnotesize}
        \captionof{figure}{Gradient radiálního profilu jasu povrchu komety (mag)}
        \label{fig:grad}
        \vspace{10pt}
        \raggedright 
    \end{minipage}
    ...
    \begin{minipage}[t]{0.5\textwidth} 
        \vspace{-15pt}   
        \par \centering
        \includegraphics[scale=0.35]{sbp_counts.png}
        \captionsetup{justification=centeringfont=footnotesize}
        \captionof{figure}{Radiální profil jasu povrchu komety (counts)}
        ...
        \vspace{10pt}     
        \par \centering
        \includegraphics[scale=0.35]{grad_counts.png}
        \captionsetup{justification=centeringfont=footnotesize}
        \captionof{figure}{Gradient radiálního profilu jasu povrchu komety (counts)}
